...
public class Prefs extends K9PreferenceActivity {
    ...
    private static final String PREFERENCE_RECEIVE_MAIL_NOTIFY = "receive_mailnotify";
    private static final String PREFERENCE_RECEIVE_WAP_PUSH = "receive_wappush";
    ...
    private CheckBoxPreference mReceiveMailNotify;
    private CheckBoxPreference mReceiveWapPush;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mReceiveMailNotify = (CheckBoxPreference)findPreference(PREFERENCE_RECEIVE_MAIL_NOTIFY);
        mReceiveMailNotify.setChecked(K9.receiveMailNotify());

        mReceiveWapPush = (CheckBoxPreference)findPreference(PREFERENCE_RECEIVE_WAP_PUSH);
        mReceiveWapPush.setChecked(K9.receiveWapPush());
    }
    ...
    private void saveSettings() {
        ...
        K9.setReceiveMailNotify(mReceiveMailNotify.isChecked());
        K9.setReceiveWapPush(mReceiveWapPush.isChecked());
